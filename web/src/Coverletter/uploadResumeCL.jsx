...
const UploadResumeCL= () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setTimeout(() => navigate("/Coverletter"), 1000);
    } catch (error) {
    ...
    <div className="relative isolate overflow-hidden bg-gray-900">
      ...
      <header className="bg-white/10 dark:bg-gray-700 shadow-md py-6">
        <div className="container mx-auto px-4">
          ...
          Your ultimate tool for crafting compelling cover letters.
          </p>
        </div>
      </header>
      ...
      >
        ...
        <div className=" mt-0 pt-0 mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          Utilize cutting-edge technology to refine your cover letter, gain tailored insights, and create compelling applications that stand out to potential employers
          </p>
          <form
           onSubmit={(e) => {
            e.preventDefault(); // Prevent the default form submission behavior
            handleUpload(); // Call the upload handler
  ...
  <div className="flex flex-col space-y-1.4 p-4">
    ...
    >
      <svg
        ...
        className="lucide lucide-edit w-6 h-6 text-white"
      >
        <path d="M12 20h9" />
        <path d="M16.5 3.5l4 4L7 21H3v-4L16.5 3.5z" />
      </svg>
    </div>
    <h3 className="text-xl font-semibold leading-none tracking-tight">Craft Your Cover Letter</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Use our tool to draft a professional and impactful cover letter effortlessly.</p>
  </div>
</div>
  ...
  <div className="flex flex-col space-y-1.4 p-4">
    ...
    >
      ...
      >
        <path d="M9 18h6" />
        <path d="M10 22h4" />
        <path d="M4 10a8 8 0 1 1 16 0 8.1 8.1 0 0 1-3.5 6.62c-.4.28-.5.78-.5 1.25v.13a1.77 1.77 0 0 1-1.77 1.77h-4.46A1.77 1.77 0 0 1 8 18v-.13c0-.47-.1-.97-.5-1.25A8.1 8.1 0 0 1 4 10Z" />
      </svg>
    </div>
    <h3 className="text-xl font-semibold leading-none tracking-tight">Personalized Insights</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Get tailored recommendations to highlight your strengths and experiences effectively.</p>
  </div>
</div>
...
<div className="w-80 h-42 rounded-lg border bg-card text-white shadow-sm">
  <div className="flex flex-col space-y-1.4 p-4">
    ...
    <h3 className="text-xl font-semibold leading-none tracking-tight">Optimize for Impact</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Ensure your cover letter aligns with the job requirements and stands out to recruiters.</p>
  </div>
</div>
